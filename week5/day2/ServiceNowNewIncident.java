...
public class ServiceNowNewIncident extends BaseClassServiceNow {

	@Test(priority=1)
	public void runServiceNowNewIncident() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='incident.short_description']")).sendKeys("New incident report by Vishva");
